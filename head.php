...
<div class="body-content">
    ...
    <header class="top-bar con-min-width visible-md-up">
      <div class="con height-100p flex flex-jc-sb">
        ...
        <span><img src="https://raw.githubusercontent.com/taenui/blog/master/immoji.png" alt=""></span>
    <span>TAENUI</span>
        </a>
        <nav class="top-bar__menu-box-1 height-100p">
          <ul class="flex height-100p">
            ...
            <li>
              <a href="pf/index.ssghtml.php" class="flex flex-jc-c flex-ai-c height-100p">
