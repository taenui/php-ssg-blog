  ...
  <div class="cols">
			<div class="col" ontouchstart="this.classList.toggle('hover');">
              ...
              <span>NCS 능력 이수</span>
					...
					<div class="back">
						<div class="inner">
						  <p>2020.10 ~ 2021.04월까지 <br> SBS아카데미학원에서의 스마트기기 UX/UI 디자인 양성과정을 이수하였습니다.</p>
						</div>
					</div>
				</div>
			</div>
			<div class="col" ontouchstart="this.classList.toggle('hover');">
				<div class="container">
					<div class="front" style="background-image: url(https://cdn.jsdelivr.net/gh/taenui/php-ssg-blog/pf/img/behind/coding.png">
						<div class="inner">
							<p></p>
              <span>코딩</span>
						</div>
					...
					<div class="back">
						<div class="inner" >
							<p>부족한 부분을 채우기 위해 <br> 브이로그로 기록하며 코딩연습을 했습니다.<br><br><a href="https://to2.kr/bEF" style="text-decoration:underline;">Click</a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col" ontouchstart="this.classList.toggle('hover');">
              ...
              <span>꾸준한 그림연습</span>
					...
					<div class="back">
						<div class="inner">
							<p>틈이 날 때마다 스케치와 그림 실력을 위해 연습하고 있습니다.</p>
						</div>
					</div>
				</div>
			</div>
			<div class="col" ontouchstart="this.classList.toggle('hover');">
              ...
              <span>10년의 다양한 알바 경험</span>
					...
					<div class="back">
						<div class="inner">
							<p>10년동안 꾸준히 알바를 통하여 책임감과 대인관계에 대해 배웠습니다.</p>
						</div>
					</div>
				</div>
			</div>
			<div class="col" ontouchstart="this.classList.toggle('hover');">
              ...
              <span>디자인 창작</span>
					...
					<div class="back">
						<div class="inner" style="background-image: url(https://cdn.jsdelivr.net/gh/taenui/php-ssg-blog/pf/img/behind/design.png)">
