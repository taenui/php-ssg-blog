...
<div class="wrapper">
  ...
  <div class="cols">
			...
			<div class="col" ontouchstart="this.classList.toggle('hover');">
				<div class="container">
					<div class="front" style="background-image: url(https://github.com/taenui/Sites/blob/main/pf/img/behind/coding.png?raw=true">
						<div class="inner">
							<p></p>
              <span>코딩</span>
						</div>
			...
			<div class="col" ontouchstart="this.classList.toggle('hover');">
              ...
              <span>취미생활</span>
					...
					<div class="back">
						<div class="inner">
							<p>가죽공예, 목공예 등의 다양한 공예를 통해 디자인적인 감각을 연습해보았습니다.</p>
						</div>
					</div>
				</div>
			</div>
